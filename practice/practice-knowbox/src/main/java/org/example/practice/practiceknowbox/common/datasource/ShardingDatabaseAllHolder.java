 ...
 */
@Slf4j
public class ShardingDatabaseAllHolder implements Serializable {
    ...
    public ShardingDatabaseAllHolder(List<ShardingDataSourceHolder> holders) {
    ...
    public void removeDataSourceShardingIndex(String dbName) {
        ...
        holder.getDatabaseShardingIndex().remove();
    }
    ...
    public void setTableShardInfo(String dbName, String tableName, long id) {
        ...
        if (config == null) {
            ...
            config.put(tableName, new ShardTableConfig(id, this.fetchTableShardSize(tableName)));
        }
