...
import org.example.practice.practicespring.web.interceptor.RestTemplateInterceptor;
import org.example.practice.practicespring.web.interceptor.SimpleRestTemplateInterceptor;
...
public class RestTemplateConfig {
    ...
    @Value("${restTemplate.client.connectionRequestTimeout:200}")
    private int connectionRequestTimeout;
    @Value("${restTemplate.client.connectTimeout:100}")
    private int connectTimeout;
    @Value("${restTemplate.client.socketTimeout:300}")
