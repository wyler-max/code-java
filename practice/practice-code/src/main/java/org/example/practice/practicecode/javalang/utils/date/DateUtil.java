package org.example.practice.practicecode.javalang.utils.date;
 ...
 * 时间工具类
 *
 * 1、SimpleDateFormat 是线程不安全的 public static final SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
 * 2、是线程安全的 3、Joda-Time Joda-Time与以上两种有所区别，不仅仅可以对时间进行格式化输出，而且可以生成瞬时时间值，并与Calendar、Date等对象相互转化，极大的方便了程序的兼容性
...
public class DateUtil {
     ...
     *            参照的时间
     * @param field
     *            Calendar属性 SECOND、MINUTE、HOUR、HOUR_OF_DAY 等
     * @param interval
     *            时间间隔；比如获取一小时后的时间：getIntervalDate
     * @return
     */
