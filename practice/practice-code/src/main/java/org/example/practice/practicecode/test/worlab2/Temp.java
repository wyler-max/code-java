package org.example.practice.practicecode.test.worlab2;
...
public class Temp {
    ...
    public static List<QueryClassListDto> popGivenClassNumbers(List<QueryClassListDto> classList,
    ...
    public static List<QueryClassListDto> popGivenClassNumbers2(List<QueryClassListDto> classList,
        List<Integer> classNumbers) {
