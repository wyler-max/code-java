package org.example.practice.practicecode.javalang.grammar;
...
public class TestParams {
    ...
    private static void func(Demo1 d2) {
        /**
         * 1. d2 指向 d1 对象的地址 2. d2.temp（=d1.temp） 对象指向 new
         */
        d2.temp = 30;
    }
    ...
    private static void func(String s2) {
        /**
         * 1. s2 指向 s1 = new String("hello") 对象的地址 2. s2 指向 new String("world") 对象的地址 3. 方法内的局部变量 s2 被回收
         */
        s2 = "world";
    }
