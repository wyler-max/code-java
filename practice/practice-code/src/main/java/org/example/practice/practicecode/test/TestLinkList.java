...
public class TestLinkList {
    ...
    /**
     * 单链表分解 将单链表拆分成 l1/l2 2个链表；对应指针p1/p2 遍历单链表： case p.val < x：p1.next = p case p.val >= x：p2.next = p 拼接 p1.next =
     * l2.next
     */
    ...
    /**
     * 合并多个有序链表 1、构造有序队列 2、将各链表的head添加到有序队列中 3、从有序队列中取值，并更新node
     */
