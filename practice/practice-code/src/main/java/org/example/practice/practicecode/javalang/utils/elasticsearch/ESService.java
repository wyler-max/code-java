...
import org.example.practice.practicecode.javalang.utils.JsonUtil;
...
public class ESService {
    ...
    public static SearchRequest ofDemoSearchRequest() {
        ...
        sourceBuilder.query(QueryBuilders.boolQuery().should(QueryBuilders.matchQuery("name", "wang"))
            .should(QueryBuilders.matchQuery("id", "1")));
        ...
        sourceBuilder.query(QueryBuilders.boolQuery().should(QueryBuilders.matchQuery("name1", "wang"))
            .should(QueryBuilders.matchQuery("name2", "wang")).should(QueryBuilders.matchQuery("name3", "wang"))
        ...
        sourceBuilder.query(QueryBuilders.boolQuery().must(QueryBuilders.existsQuery("name1"))
            .mustNot(QueryBuilders.existsQuery("name2")));
