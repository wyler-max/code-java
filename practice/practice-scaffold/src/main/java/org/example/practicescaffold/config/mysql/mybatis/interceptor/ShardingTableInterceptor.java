package org.example.practicescaffold.config.mysql.mybatis.interceptor;
...
import org.example.practicescaffold.common.utils.StringsUtil;
import org.example.practicescaffold.config.mysql.sharding.ShardTableConfig;
...
public class ShardingTableInterceptor implements Interceptor {
    ...
    public ShardingTableInterceptor(ShardingDataSourceHolderAll holder) {
        this.holder = holder;
    }
    ...
    private void doTable(StatementHandler handler, MetaObject metaStatementHandler) throws ClassNotFoundException {
        ...
        if (StringUtils.isNotBlank(originalSql)) {
            ...
            if (config != null) {
                ...
                AccessLogInfo.addParams(shardingTable, StringUtils.EMPTY);
